...
class CreateLibrarianPopupView(QWidget):
    ...
    def setup_ui(self):
        ...
        subtitle = QLabel("Create a new librarian account")
        ...
        save_btn = QPushButton("Create Librarian")
        save_btn.setObjectName("saveButton")
        save_btn.clicked.connect(self.controller.save_librarian)
