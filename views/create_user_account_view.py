...
class CreateUserAccountView(QWidget):
    ...
    def setup_ui(self):
        ...
        main_card.setFixedSize(470, 610)
        ...
        subtitle = QLabel("Add a new student account to the library system")
        ...
        create_btn = QPushButton("Create Student Account")
        create_btn.setObjectName("createButton")
        create_btn.clicked.connect(self.controller.save_student_from_librarian)

        back_btn = QPushButton("Back to Dashboard")
        back_btn.setObjectName("backButton")
        back_btn.clicked.connect(self.controller.back_to_librarian_dashboard)
