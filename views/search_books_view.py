...
class SearchBooksView(QWidget):
    ...
    def setup_ui(self):
        ...
        main_card.setFixedSize(900, 580)
        ...
        subtitle = QLabel("Search books by title, author, category, or status")
        ...
        self.search_input.setPlaceholderText("Type a keyword to search books...")

        search_btn = QPushButton("Search")
        search_btn.setObjectName("searchButton")
        search_btn.clicked.connect(self.controller.search_books_action)

        show_all_btn = QPushButton("Show All")
        show_all_btn.setObjectName("showAllButton")
        show_all_btn.clicked.connect(self.controller.load_all_books_for_search)
    ...
    def handle_back(self):
        source = self.controller.auth_controller.search_books_source

        if source == "student":
            self.controller.back_to_student_dashboard_from_search()
        else:
            self.controller.back_to_librarian_dashboard_from_search()
